...
Zscores <- read_excel("./data/Rbg_ANs_data.xlsx", sheet = "Z-scores")
...
# 15 variables follow a normal distribution
...
Metadata <- read_excel("./data/Rbg_ANs_final_data.xlsx", sheet = "Rbg_metadata")
...
## beanplots según la especie

par(mfrow=c(3, 2)) # culture media 1 to 6 at 3 days
bp_AN01_3d<-Zscores$AN01_3d~Metadata$Species 
beanplot(bp_AN01_3d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN01 (3 days)")
bp_AN02_3d<-Zscores$AN02_3d~Metadata$Species
beanplot(bp_AN02_3d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN02 (3 days)")
bp_AN03_3d<-Zscores$AN03_3d~Metadata$Species
beanplot(bp_AN03_3d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN03 (3 days)")
bp_AN04_3d<-Zscores$AN04_3d~Metadata$Species
beanplot(bp_AN04_3d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN04 (3 days)")
bp_AN05_3d<-Zscores$AN05_3d~Metadata$Species
beanplot(bp_AN05_3d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN05 (3 days)")
bp_AN06_3d<-Zscores$AN06_3d~Metadata$Species
beanplot(bp_AN06_3d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN06 (3 days)")

par(mfrow=c(3, 2)) # culture media 7 to 12 at 3 days
bp_AN07_3d<-Zscores$AN07_3d~Metadata$Species 
beanplot(bp_AN07_3d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN07 (3 days)")
bp_AN08_3d<-Zscores$AN08_3d~Metadata$Species
beanplot(bp_AN08_3d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN08 (3 days)")
bp_AN09_3d<-Zscores$AN09_3d~Metadata$Species
beanplot(bp_AN09_3d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN09 (3 days)")
bp_AN10_3d<-Zscores$AN10_3d~Metadata$Species
beanplot(bp_AN10_3d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN10 (3 days)")
bp_AN11_3d<-Zscores$AN11_3d~Metadata$Species
beanplot(bp_AN11_3d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN11 (3 days)")
bp_AN12_3d<-Zscores$AN12_3d~Metadata$Species
beanplot(bp_AN12_3d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN12 (3 days)")

par(mfrow=c(3, 2)) # culture media 1 to 6 at 7 days
bp_AN01_7d<-Zscores$AN01_7d~Metadata$Species 
beanplot(bp_AN01_7d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN01 (7 days)")
bp_AN02_7d<-Zscores$AN02_7d~Metadata$Species
beanplot(bp_AN02_7d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN02 (7 days)")
bp_AN03_7d<-Zscores$AN03_7d~Metadata$Species
beanplot(bp_AN03_7d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN03 (7 days)")
bp_AN04_7d<-Zscores$AN04_7d~Metadata$Species
beanplot(bp_AN04_7d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN04 (7 days)")
bp_AN05_7d<-Zscores$AN05_7d~Metadata$Species
beanplot(bp_AN05_7d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN05 (7 days)")
bp_AN06_7d<-Zscores$AN06_7d~Metadata$Species
beanplot(bp_AN06_7d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN06 (7 days)")

par(mfrow=c(3, 2)) # culture media 7 to 12 at 7 days
bp_AN07_7d<-Zscores$AN07_7d~Metadata$Species 
beanplot(bp_AN07_7d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN07 (7 days)")
bp_AN08_7d<-Zscores$AN08_7d~Metadata$Species
beanplot(bp_AN08_7d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN08 (7 days)")
bp_AN09_7d<-Zscores$AN09_7d~Metadata$Species
beanplot(bp_AN09_7d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN09 (7 days)")
bp_AN10_7d<-Zscores$AN10_7d~Metadata$Species
beanplot(bp_AN10_7d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN10 (7 days)")
bp_AN11_7d<-Zscores$AN11_7d~Metadata$Species
beanplot(bp_AN11_7d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN11 (7 days)")
bp_AN12_7d<-Zscores$AN12_7d~Metadata$Species
beanplot(bp_AN12_7d,col=colorBlindGrey8[1:5], bw="nrd0", xlab="Species", ylab="AN12 (7 days)")
...
bp_AN09_3d<-Zscores$AN08_3d~Metadata$Origin
...
library(xlsx)
write.xlsx(r, file="./results/Rbg_zscores_correlation.xlsx", sheetName="Spearman corr coef", row.names=TRUE)
write.xlsx(P, file="./results/Rbg_zscores_correlation.xlsx", sheetName="p-values", append=TRUE, row.names=TRUE)
write.xlsx(Padj, file="./results/Rbg_zscores_correlation.xlsx", sheetName="adjusted p-values", append=TRUE, row.names=TRUE)
...
summary(pca)
# The 2 first principal components explain only 31,68% of the variance. 
...
ggplot(data = loadings, aes(x = Component1, y = Component2, label = label)) + 
  ...
  geom_text(
    ...
    color = 'firebrick') + 
  xlim(c(-0.5,0.6)) + ylim(c(-0.5,0.3)) #Loadings plot with arrows
...
# the ellipses corresponding to the 2 species are overlapped
